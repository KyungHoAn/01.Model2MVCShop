		...
		<table width="600" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				...
				<input type="hidden" name="buyerId"
					value="<%=purchaseVO.getBuyer().getUserId()%>" />
			</tr>
			<tr>
				<td height="1" colspan="3" bgcolor="D6D6D6"></td>
			</tr>
		<tr>
			...
			<tr>
				...
				<td class="ct_write01"><input type="text" name="receiverName"
					...
					maxLength="20" value="<%=purchaseVO.getBuyer().getUserName()%>"></td>
			</tr>
			<tr>
				<td height="1" colspan="3" bgcolor="D6D6D6"></td>
			</tr>
			<tr>
				...
				<td class="ct_write01"><input type="text" name="receiverPhone"
					class="ct_input_g" style="width: 100px; height: 19px"
					maxLength="20" value="<%=purchaseVO.getBuyer().getPhone()%>" /></td>
			</tr>
			...
			<tr>
				...
				<td class="ct_write01"><input type="text" name="receiverAddr"
					class="ct_input_g" style="width: 100px; height: 19px"
					maxLength="20" value="<%=purchaseVO.getBuyer().getAddr()%>" /></td>
			</tr>
			<tr>
				<td height="1" colspan="3" bgcolor="D6D6D6"></td>
			</tr>
			<tr>
				...
				<td class="ct_write01"><input type="text"
					...
					value="<%=purchaseVO.getDivyRequest()%> " /></td>
			</tr>
			<tr>
				<td height="1" colspan="3" bgcolor="D6D6D6"></td>
			</tr>
					...
					<table border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td background="/images/ct_btnbg02.gif" class="ct_btn01"
								...
								href="javascript:fncAddPurchase();">수정</a></td>
